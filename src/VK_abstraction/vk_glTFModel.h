...
namespace vkglTF
{
	...
	*/
	struct Mesh {
		...
		Mesh(vkc::VkcDevice* device, glm::mat4 matrix);
		~Mesh();
	};
	...
	*/
	...
	public:
		...
		void loadImages(tinygltf::Model& gltfModel, vkc::VkcDevice* device, VkQueue transferQueue);
